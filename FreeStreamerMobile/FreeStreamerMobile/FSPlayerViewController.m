...
//    else if (self.selectedPlaylistItem.data) {
//        self.audioController.data = self.selectedPlaylistItem.data;
//    }
}
...
- (FSAudioController *)audioController
{
    if (!_audioController) {
        ...
        _audioController.enableDebugOutput = YES;
        _audioController.audioDataDecrypt = ^NSData *(NSURL *audioFile) {
            return [NSData dataWithContentsOfURL:audioFile];
        };
    }
